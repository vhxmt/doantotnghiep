...
router.post("/create_payment_url", function (req, res, next) {
  ...
  // KHÔNG thêm vnp_BankCode - để người dùng chọn trên trang VNPAY
  // Nếu muốn chỉ định ngân hàng, dùng mã hợp lệ như: NCB, VNPAYQR, VNBANK, etc.
  // if (bankCode && bankCode !== "" && bankCode !== null && bankCode !== undefined) {
